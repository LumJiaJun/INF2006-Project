...
- Evaluation: Histogram gradient boosting was selected by median per-city normalized MAE. On 55,363 held-out rows it achieved MAE 191.525, RMSE 629.238, and R-squared 0.644 in pooled local-currency units. Log-price R-squared was 0.850. Per-city metrics are in `artifacts/model_evaluation.json` and are more interpretable than the pooled currency metrics.
