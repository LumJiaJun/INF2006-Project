...
- **Build command:** `docker build --platform linux/amd64 --provenance=false -f src/backend/predict/Dockerfile -t airbnb-prediction:1.0.1 .`
...
- **Published image:** Tag `1.0.1`, Docker V2 single-architecture manifest, compressed size 350,361,746 bytes.
